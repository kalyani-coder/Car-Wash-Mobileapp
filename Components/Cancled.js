        ...
        <ScrollView
          ...
          >
            ...
            <View style={styles.button}>
              <TouchableOpacity
                onPress={() => this.handleButtonPress("button1")}
                style={[
                  styles.btn1,
              ...
              <TouchableOpacity
                onPress={() => this.handleButtonPress("button2")}
                style={[
                  styles.btn2,
          ...
          >
            ...
            <View style={styles.button}>
              <TouchableOpacity
                onPress={() => this.handleButtonPress("button3")}
                style={[
                  styles.btn1,
              ...
              <TouchableOpacity
                onPress={() => this.handleButtonPress("button4")}
                style={[
                  styles.btn2,
          ...
          >
            ...
            <View style={styles.button}>
              <TouchableOpacity
                onPress={() => this.handleButtonPress("button5")}
                style={[
                  styles.btn1,
              ...
              <TouchableOpacity
                onPress={() => this.handleButtonPress("button6")}
                style={[
                  styles.btn2,
